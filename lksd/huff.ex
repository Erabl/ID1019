defmodule Huffman do
  ...
  def build([{b,a}]) do end #basfallbasfallbasfall
  def build([{h,x},{n,y}|t]) do
      inserth({[h,n],x+y},t)
      build(t)
  end

  def freq() do freq(sample,[]) end
  ...
  def freq([c|r], l) do
   ...
   l = append(l, [{c, x}])
   freq(r,l)
#    you freqqing freqz, when will you learn, when will you learn, 
#    T H A T  Y O U R  A C T I O N S  H A V E  C O N S E Q U E N C E SA
  end
